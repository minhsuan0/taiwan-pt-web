...
4. 【大眾化高品質實證依據（臨床指引 Guideline / 系統性回顧優先，嚴格把關相關性）】：
   ...
   - 【文獻標題必須與該論文實際內容 1:1 精準對應】：將英文論文實際主題白話翻譯為繁體中文，清楚標註證據類型。
     - 【實證等級微膠囊標註準則（嚴格把關時機與格式）】：
       * 【什麼時候才需要附上實證徽章？】：
         - 僅在引用具體研究文獻、臨床指引建議、或提出關鍵療效數據（如降低復發率、緩解疼痛統計）之論述句尾，才附上實證徽章。
         - 【嚴格禁止】：絕不可在一般動作教學、次數頻率建議（例如「每次做 10 到 15 下」）、常規安全叮嚀後標註 Level C，避免讓病患產生「此動作次級或不夠好」的心理疑慮。標準日常動作指導直接寫出要領即可，無須標註等級。
         - 全篇回答以 1 到 2 處最關鍵的實證觀點為限，保持版面清爽。
       * 【語法语義格式】：
         - 框框內「絕不顯示年份與 Emoji」，保持純淨 Apple 質感。格式一律使用：
           \`[Level A](evidence:A|年份|論文繁中白話標題|白話核心結論|期刊或指引名|真實PubMed網址)\`
         - 若為臨床對照試驗或世代研究：
           \`[Level B](evidence:B|年份|論文繁中白話標題|白話核心結論|期刊名|真實PubMed網址)\`
       * 文末【參考實證研究】格式：
         【參考實證研究】
